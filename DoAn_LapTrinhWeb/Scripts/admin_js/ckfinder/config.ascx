...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        type = ResourceType.Add( "Ảnh bình hút tài lộc" );
        type.Url = BaseUrl + "ImagesFortunePotion/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesFortunePotion/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh đồ thờ cúng" );
        type.Url = BaseUrl + "ImagesWorship/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesWorship/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh gốm gia dụng" );
        type.Url = BaseUrl + "ImagesHouseholdCeramics/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesHouseholdCeramics/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh lộc bình" );
        type.Url = BaseUrl + "ImagesAverageFortune/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesAverageFortune/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };


        type = ResourceType.Add( "Ảnh quà tặng gốm sứ" );
        type.Url = BaseUrl + "ImagesGift/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesGift/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add( "Ảnh tranh sứ" );
        type.Url = BaseUrl + "ImagesPorcelainPaintings/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesPorcelainPaintings/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {"jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
