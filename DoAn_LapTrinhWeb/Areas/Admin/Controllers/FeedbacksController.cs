...
namespace DoAn_LapTrinhWeb.Areas.Admin.Controllers
{
    public class FeedbacksController : BaseController
    {
            ...
            if (User.Identity.IsAuthenticated)
            {
                if (User.Identity.Permiss_Update() == true || User.Identity.Permiss_Modify() == true)
                {
                    ...
                    if (feedback != null)
                    {
                        ...
                        string FeebackProduct = "<tr style='border-bottom: 1px solid rgba(0,0,0,.05);' class='product_item'>" +
                                              "<td valign='middle' width ='80%' style='text-align:left; padding:0 2.5em;'> " +
                                                  "<div class='product-entry'>" +
                                                      "<img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1672574357/Email/logo_hgxipm.png" + feedback.Product.image + "' style = 'width: 100px; max-width: 600px; height: auto; padding-bottom:5px; display: block;'>" +
                                                      "<div class='text'>" +
                        ...
                        { star = "<img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> "; }
                        else if (feedback.rate_star == 2)
                        { star = "<img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'>"; }
                        else if (feedback.rate_star == 3)
                        { star = "<img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'>"; }
                        else if (feedback.rate_star == 4)
                        { star = "<img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star-o_yuph59_lklztn.png'>"; }
                        else
                        { RatingStar = "<img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'> <img src='https://res.cloudinary.com/dubr0jq2x/image/upload/v1673010082/Email/star_zxwzal_ricaex.png'>"; }
                        RatingStar = star;
        ...
        public void SendEmailFeedback(string RatingStar, string FeedbackProduct, string FeedbackStatus, string emailID,string Feedbackid, string productname,  string feedbackcontent, string productslug, string emailFor)
        {
            ...
            ///để dùng google email gửi email reset cho người khác "https://www.google.com/settings/security/lesssecureapps" Cho phép ứng dụng kém an toàn: Bật
            var fromEmail = new MailAddress(AccountEmail.UserEmail, AccountEmail.Name); //"tên hiển thị mail khi gửi"
